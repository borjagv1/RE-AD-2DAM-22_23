...
public class NeodatisEvaluacionesImpl implements EvaluacionesDAO{
	...
	public ArrayList<Evaluaciones> DatosTodasLasEvaluaciones() {
		...
		throw new UnsupportedOperationException("Unimplemented method 'DatosTodasLasEvaluaciones'");
	}

	@Override
	public ArrayList<Evaluaciones> DatosUnaEvaluacion(int eva) {
		// TODO Auto-generated method stub
		throw new UnsupportedOperationException("Unimplemented method 'DatosUnaEvaluacion'");
	}

	@Override
	public ArrayList<Evaluaciones> EvaluacionesAlumno(int eva, int codigo) {
		// TODO Auto-generated method stub
		throw new UnsupportedOperationException("Unimplemented method 'EvaluacionesAlumno'");
	}
