...
import examen2022.datosRA5.*;

public class CrearBD_RA5_22 {

	static MongoClient cliente = new MongoClient();
	static MongoDatabase db = cliente.getDatabase("GuerraValenciaBorja");
	...
	private static void llenarVendedores()  {
		...
		// creo la colecci�n. Si existe la borro y la creo de nuevo.
		try {
		...
		v[6] = new Vendedor(5050, "MART�N", 1040.60f, 79, "", 0);
	...
	private static void llenarZonas()  {
		...
		String nombrezona[] = { "ALCARRIA", "ARA�UELO", "ALTO TAJO", "SERRANIA", "MANCHUELA", "LA JARA" };
		String prov[] = { "GUADALAJARA", "C�CERES", "GUADALAJARA", "CUENCA", "ALBACETE", "TOLEDO" };
