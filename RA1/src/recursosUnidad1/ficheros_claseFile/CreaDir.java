package recursosUnidad1.ficheros_claseFile;
import java.io.*;
public class CreaDir {
 public static void main(String[] args) {
   File d = new File("NUEVODIR"); //directorio que creo a partir del actual pùedo poner "C:\\xampp", "NUEVODIR" p.ej
   ...
   if (f2.delete()) {
      ...
      System.out.println("No se ha podido BORRAR FICHERO2...");  
 }
}
